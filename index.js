...
app.config(['$logProvider', '$routeProvider', function ($logProvider, $routeProvider) {
    ...
    $routeProvider
        ...
        .when('/timepicker', {
            templateUrl: './controller/datetime-picker/timepicker.html',
        ...
        .when('/datePicker', {
            templateUrl: './controller/date-picker/date-picker.html',
        ...
        .when('/tag', {
            templateUrl: './controller/tag/index.html',
            controller: 'TagCtrl'
        })
        .when('/z-index-demo', {
        ...
        .when('/notification', {
            templateUrl: './controller/notification/index.html',
...
app.run(['$rootScope', '$log', '$animate', function ($rootScope, $log, $animate) {
    ...
    $rootScope.menuList = [
        ...
        {label: 'Notification 通知', path: '/notification'},
